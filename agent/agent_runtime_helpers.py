...
def recover_with_credential_pool(
    ...
    *,
    ...
    should_rotate_credential: bool = True,
) -> tuple[bool, bool]:
    ...
    if effective_reason == FailoverReason.billing:
        if not should_rotate_credential:
            # Anthropic OAuth "out of extra usage" 400 is usually a tool-name /
            # system-prompt lane mismatch — rotating the same OAuth cred loops.
            return False, has_retried_429
